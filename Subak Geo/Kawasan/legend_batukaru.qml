...
<qgis version="2.2.0-Valmiera" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="NAME" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="Hutan Lahan Kering Primer" label="Hutan Lahan Kering Primer"/>
      <category symbol="1" value="Hutan Lahan Kering Sekunder" label="Hutan Lahan Kering Sekunder"/>
      <category symbol="2" value="Hutan Tanaman Industri (HTI)" label="Hutan Tanaman Industri (HTI)"/>
      <category symbol="3" value="Perkebunan" label="Perkebunan"/>
      <category symbol="4" value="Permukiman" label="Permukiman"/>
      <category symbol="5" value="Pertanian Lahan Kering" label="Pertanian Lahan Kering"/>
      <category symbol="6" value="Pertanian Lahan Kering Bercampur dengan Semak" label="Pertanian Lahan Kering Bercampur dengan Semak"/>
      <category symbol="7" value="Savana" label="Savana"/>
      <category symbol="8" value="Sawah" label="Sawah"/>
      <category symbol="9" value="Semak/Belukar" label="Semak/Belukar"/>
      <category symbol="10" value="Tubuh Air" label="Tubuh Air"/>
      <category symbol="11" value="" label=""/>
    </categories>
    <symbols>
      ...
      <symbol alpha="1" type="fill" name="8">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_unit" v="MM"/>
          <prop k="color" v="111,228,174,255"/>
          <prop k="color_border" v="0,0,0,255"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="style" v="solid"/>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="0" name="HECTARES"/>
